...
def main():
    try:
        with open('/media3/shiyi/agent/multi-agent-new/LOT/debate_result_new/LOT_SR+COT+FB.json', 'r',
    ...
    try:
        with open('/media3/shiyi/agent/multi-agent-new/LOT/debate_result_new/LOT_SR+COT+FB.pkl',
                  'rb') as progress_file:
    ...
    for idx, story in enumerate(stories[start_index:]):
        ...
        while True:
            try:
                ...
                with open('/media3/shiyi/agent/multi-agent-new/LOT/debate_result_new/LOT_SR+COT+FB.json', 'w',
                          encoding='utf-8') as file:
