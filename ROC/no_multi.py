...
def main():
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/no_multi.json', 'r',
    ...
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/no_multi.pkl',
                  'rb') as progress_file:
    ...
    for idx, story in enumerate(stories[start_index:]):
        ...
        while True:
            try:
                ...
                with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/no_multi.json', 'w',
                          encoding='utf-8') as file:
