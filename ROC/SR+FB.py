...
def main():
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_SR+FB.json', 'r',
    ...
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_SR+FB.pkl',
                  'rb') as progress_file:
    ...
    for idx, story in enumerate(stories[start_index:]):
        ...
        while True:
            try:
                ...
                with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_SR+FB.json', 'w',
                          encoding='utf-8') as file:
