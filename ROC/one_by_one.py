...
def main():
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_one_by_one+FB.json', 'r',
    ...
    try:
        with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_one_by_one+FB.pkl',
                  'rb') as progress_file:
    ...
    for idx, story in enumerate(stories[start_index:]):
        ...
        while True:
            try:
                ...
                with open('/media3/shiyi/agent/multi-agent-new/ROC/debate_result_new/ROC_one_by_one+FB.json', 'w',
                          encoding='utf-8') as file:
