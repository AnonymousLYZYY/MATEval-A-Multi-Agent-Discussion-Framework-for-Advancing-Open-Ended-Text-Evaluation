...
def main():
    try:
        with open('/media3/shiyi/agent/multi-agent-new/WP/debate_result_new/WP_COT+FB.json', 'r',
    ...
    try:
        with open('/media3/shiyi/agent/multi-agent-new/WP/debate_result_new/WP_COT+FB.pkl',
                  'rb') as progress_file:
    ...
    for idx, story in enumerate(stories[start_index:]):
        ...
        while True:
            try:
                ...
                with open('/media3/shiyi/agent/multi-agent-new/WP/debate_result_new/WP_COT+FB.json', 'w',
                          encoding='utf-8') as file:
